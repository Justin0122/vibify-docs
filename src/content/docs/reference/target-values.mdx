...
- time_signature (0 to 5) - the time signature of the song
...
const recommendations = await spotify.getRecommendations('user-id', 'pop', true, true, true, false, true, false, targetValues);
```